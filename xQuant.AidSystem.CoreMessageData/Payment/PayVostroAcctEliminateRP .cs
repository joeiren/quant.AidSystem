...
namespace xQuant.AidSystem.CoreMessageData
{
    ...
    /// 来账的销账应答协议报文
    /// </summary>
    public class PayVostroAcctEliminateRP : IMessageRespHandler
    {
        public const UInt32 TOTAL_WIDTH = 126 + PaymentBizMsgDataBase.HEADER_WIDTH;
        #region Property
        /// <summary>
        /// 交易结果,00—成功,其他—失败,X2
        /// </summary>
        ...
        public object FromBytes(byte[] messagebytes)
        {
            if (messagebytes.Length >= TOTAL_WIDTH - PaymentBizMsgDataBase.HEADER_WIDTH)
            {
                ...
                PendingSN = CommonDataHelper.GetValueFromGBKBytes(ref messagebytes, 14);
            }
            return this;
        }
